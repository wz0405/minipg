...
CREATE TABLE SI_PTN_FEE (
    ...
    PAY_METHOD    VARCHAR(10)  NOT NULL DEFAULT 'CARD' COMMENT '결제수단',
    APPLY_DT DATE         NOT NULL COMMENT '적용 시작일',
    FEE_RATE DECIMAL(6,4) NOT NULL COMMENT '원가율 %% (PG -> 당사)',
    PRIMARY KEY (MCHT_ID, PAY_METHOD, APPLY_DT)
) COMMENT='원가 수수료 정책';

CREATE TABLE SI_STMT_FEE (
    MCHT_ID   VARCHAR(20)  NOT NULL,
    PAY_METHOD    VARCHAR(10)  NOT NULL DEFAULT 'CARD',
    APPLY_DT DATE         NOT NULL COMMENT '적용 시작일',
...
CREATE TABLE TR_MSTR (
    ...
    MCHT_ID         VARCHAR(20)  NOT NULL,
    PAY_METHOD          VARCHAR(10)  NOT NULL DEFAULT 'CARD',
    TX_STATUS      VARCHAR(10)  NOT NULL COMMENT 'APPROVED / CANCELED',
    PARTNER_CD     VARCHAR(20)  NULL COMMENT '제휴사 코드 (NICEPAY/KAKAOPAY, 자체 수단은 NULL)',
    ...
    REG_DT         DATETIME     NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (TR_SEQ),
    UNIQUE KEY UX_TR_MSTR (TID, TX_STATUS),
...
CREATE TABLE SM_STMT (
    ...
    REG_DT     DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (SETTLE_DT, MCHT_ID, PAY_METHOD)
...
CREATE TABLE SI_TERMINAL (
    TERM_NO VARCHAR(12) NOT NULL COMMENT '오프라인 단말기 번호',
    MCHT_ID VARCHAR(20) NOT NULL COMMENT '설치 가맹점',
    USE_FLG CHAR(1)     NOT NULL DEFAULT 'Y',
    REG_DT  DATETIME    NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (TERM_NO)
) COMMENT='오프라인 단말기 — VAN 통보 전문의 단말번호로 가맹점을 식별';
...
INSERT INTO SI_PTN_FEE (MCHT_ID, PAY_METHOD, APPLY_DT, FEE_RATE) VALUES
...
INSERT INTO SI_TERMINAL (TERM_NO, MCHT_ID) VALUES
    ('T1000000001', 'demostore01'),
    ('T1000000002', 'democafe02'),
    ('T2000000001', 'demobooks03');
